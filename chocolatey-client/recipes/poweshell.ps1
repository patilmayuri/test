aws s3 cp s3://arun-cloudfront-logs/windows_packages/chocolatey.0.10.7.nupkg C:\temp\chocolatey.0.10.7.nupkg

# based on local file, see above instructions for how you can obtain package
# from internal repository and download it local
$localChocolateyPackageFilePath = 'C:\temp\chocolatey.0.10.7.nupkg'
